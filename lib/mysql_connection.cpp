...
void MySQL_Connection::connect_start() {
	...
	}
	{
		...
		myds->sess->mysql_variables->server_set_value(SQL_CHARACTER_SET_RESULTS, ss.str().c_str());
		myds->sess->mysql_variables->server_set_value(SQL_CHARACTER_SET_CLIENT, ss.str().c_str());
		myds->sess->mysql_variables->server_set_value(SQL_CHARACTER_SET_CONNECTION, ss.str().c_str());
		myds->sess->mysql_variables->server_set_value(SQL_COLLATION_CONNECTION, ss.str().c_str());
	}
